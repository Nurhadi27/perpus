...
<div class="wrapper">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>Petugas/Kategori"><i class="fa fa-tags"></i>Data Kategori</a></li>
             ...
             <li><a href="<?php echo base_url(); ?>Petugas/Pengarang"><i class="fa fa-pencil-square-o"></i>Data Pengarang</a></li>
              ...
              <li><a href="<?php echo base_url(); ?>Petugas/Provinsi"><i class="fa fa-globe"></i>Data Kota</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="www.google.com">PASCA SARJANA UIN SGD BANDUNG</a>.</strong> All rights reserved.
  </footer>
