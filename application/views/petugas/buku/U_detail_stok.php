...
<div class="box box-solid box-warning">
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>petugas/Buku/update_det_buku/?id_det_buku=<?php echo $id_detail_buku;?>&id_buku=<?php echo $id_buku;?>" role="form">
