...
<div class="box box-solid box-warning">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>petugas/buku/tambah_buku"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data Buku"><i class="fa fa-plus"></i>  Tambah Data</a></div>
   <div class="btn-group"><a href="<?php echo base_url('export'); ?>"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data Buku"><i class="fa fa-plus"></i>  Export Data Buku</a></div>
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                    <a href="'.base_url().'petugas/Buku/detail_stok/?id_buku='.$op['id_buku'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Detail Stok"><i class="fa fa-list"></i></a>
                    </div>
                     <a href="'.base_url().'petugas/Buku/edit_buku/?id_buku='.$op['id_buku'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'petugas/Buku/hapus_buku/?id_buku='.$op['id_buku'].'">
