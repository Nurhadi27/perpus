...
<div class="box box-solid box-warning">
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>petugas/Buku/tambah_buku" role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $kategori['id_kategori'];?>"  disabled=disabled class="form-control" name="id_kategori" placeholder="id Lengkap" >
