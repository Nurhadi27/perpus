...
<div class="box box-solid box-warning">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>petugas/Penerbit/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Penerbit"><i class="fa fa-plus"></i>  Tambah Penerbit</a></div>
    ...
    ?>
            <tr>
                ...
                <td><?php echo $op['nama_penerbit'];?></td>
                  <td><?php $kelas=$op['id_kota'];
                    foreach ($data_provinsi ->result_array()  as $op2) {
                      if($op2['id_kota']==$kelas){
                          echo $op2['nama_kota'];
                      }
                    }?></td>
                <td>
                <?php echo 
                    '<div class="btn-group">
                     <a href="'.base_url().'petugas/Penerbit/edit/?id_penerbit='.$op['id_penerbit'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>&nbsp
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'petugas/Penerbit/delete/?id_penerbit='.$op['id_penerbit'].'">
