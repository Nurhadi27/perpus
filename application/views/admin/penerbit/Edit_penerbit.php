  ...
  <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>admin/Penerbit/update" role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $penerbit['id_penerbit'];?>"  disabled=disabled class="form-control" name="id_kota" placeholder="id Lengkap" >
                  ...
                  <div class="col-sm-5">
                   <select name="provinsi" class="js-example-basic-single form-control" data-placeholder="Klik untuk memilih">
                    ...
                    <?php foreach($data_provinsi->result_array() as $op2)
                            {
                            ?>
                              <?php  if($op2['id_kota']== $penerbit['id_kota'])
                              {
                              ?>
                                <option value="<?php echo $op2['id_kota'];?>" selected><?php echo $op2['nama_kota'];?></option>
                              <?php 
                            }
                                if ($op2['id_kota']!= $penerbit['id_kota'])
                                  {?>
                                <option value="<?php echo $op2['id_kota'];?>"><?php echo $op2['nama_kota'];?></option>
                              <?php
                                }
                                ?>
                            <?php
