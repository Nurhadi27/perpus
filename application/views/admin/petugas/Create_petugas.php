	...
	<form class="form-horizontal" method="post"  <?php echo form_open_multipart('admin/Petugas/Create');?>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="id_petugas" placeholder="Jabatan(sebagai Username login)" required="required" >
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="NIP" placeholder="" required="required" >
                  </div>
                </div>
                 <div class="form-group">
