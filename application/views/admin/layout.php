...
<div class="wrapper">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>admin/Kategori"><i class="fa fa-tags"></i>Data Kategori</a></li>
             ...
             <li><a href="<?php echo base_url(); ?>admin/Pengarang"><i class="fa fa-pencil-square-o"></i>Data Pengarang</a></li>
              ...
              <li><a href="<?php echo base_url(); ?>admin/Provinsi"><i class="fa fa-globe"></i>Data Kota</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="https://www.google.com">ICT Pascasarjana UIN SGD Bandung</a>.</strong> 
  </footer>
