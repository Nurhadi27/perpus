...
<div class="box box-solid box-success">
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>admin/Pengarang/create" role="form">
              <div class="box-body">
  ...
  <td>
    <div align ="Right"> <a  href="<?php echo base_url(); ?>admin/Pengarang"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Back</a></div>
  </td>
  </div>
  <div class="box-footer">
